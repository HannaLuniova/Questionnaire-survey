        ...
        <div class="container">
            <div class="registr__inner">
                <div class="registr__content">
                    <form class="registr__form" action="php/survey.php" method="post">
                        <h3 class="registr__title">Приглашаем всех желающих<br> принять участие в онлайн-опросе</h3>
                        <input class="registr__form-input" type="text" name="email" placeholder="✉ Email" tabindex="1" autofocus>
                        <input class="registr__form-input" type="text" name="password" placeholder="🗝 Password" tabindex="2">
                        <button class="registr__form-btn" type="submit">Регистрация</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="reason__inner">
                <div class="reason__item">
                    <!-- Дополнительный класс "reason__title--icon-1" к h4  для картинок -->
        ...
        <div class="footer__top">
            <div class="container">
                <div class="footer__top-inner">
                    <form class="footer__form" action="php/admin.php" method="post">
